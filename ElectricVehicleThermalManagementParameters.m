...
compressor_displacement = 80; % [cm^3/rev] Compressor displacement
compressor_speed_max = 3600; % [rpm] Compressor max shaft speed
...
chiller_tube_Leq = 2*0.2*chiller_tube_D*chiller_N_tubes; % [m] Additional equivalent tube length for losses due to manifold and splits.
...
battery_capacity_LUT = [280.081 276.250 276.392]; % [A*hr] Battery capacity
battery_Em_LUT = [
